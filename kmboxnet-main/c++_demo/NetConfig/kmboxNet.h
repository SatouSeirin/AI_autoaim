...
#define     cmd_trace_enable    0xbbcdddac //ʹ��Ӳ����������
...
//�����ܹ��ܵĺ����������Ƽ�ʹ�ã���ֹ�������ݰ�ץ������
int kmNet_enc_mouse_move(short x, short y);	    //�������͵�����ƶ� ok
...
int kmNet_monitor_mouse_xy(int* x, int* y);//��ѯ���xy����ֵ
int kmNet_monitor_mouse_wheel(int* wheel);//��ѯ������ֵ
