...
int main()
{
	//连接测试  必须连接正常才能操作其他API 
	 ...
	 ret= kmNet_init((char*)"192.168.2.26", (char*)"8888", (char*)"01FBC068"); //连接盒子
 ...
 //模拟人工轨迹测试
	...
	//键盘按键测试
	 ...
	 while (1)
	 {
		 kmNet_mouse_move(100, 100);		Sleep(100);
		 kmNet_mouse_left(1);				Sleep(100);
		 kmNet_mouse_left(0);				Sleep(100);
		 kmNet_mouse_move(-100, -100);		Sleep(100);
	 }
